...
# Email settings
# Defaults to console backend for development. Override via environment for SMTP.
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='no-reply@stocktracker.local')
